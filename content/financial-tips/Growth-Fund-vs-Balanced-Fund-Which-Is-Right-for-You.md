...
Growth assets are investments in things like company shares and commercial property. When the companies or properties in your fund do well, your balance grows. The flipside is that their value can fall in the short term, sometimes significantly. Over the long run, growth assets have historically outperformed income assets, but the ride can be bumpy.

Income assets are things like government bonds and cash. These are steadier, earning a more predictable return, and they’re less prone to sharp drops in value. The trade-off is that they grow more slowly over time.

Every KiwiSaver fund holds a mix of both growth and income assets. The higher the proportion of growth assets, the more potential for long-term returns, but the more short-term volatility you sign up for.

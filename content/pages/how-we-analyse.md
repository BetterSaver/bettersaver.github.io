...
principles_items:
  - number: '1'
    title: We look for like-for-like comparisons
...
weighting_heading: The four checks aren't equal.
...
grades_heading: 'We assess every fund from A+ to F. '
grades_subheading: 'Every fund we analyse is given an overall grade based on how it performs across the four core checks. B or above is the bar to make our recommended list. Funds that don''t clear it are marked Not Recommended (NR). '
grades_cards:
  - badge: A+
    css_class: aplus
    status: Recommended
    label: Top pick
    description: Stands out against peers overall.
  - badge: A
    css_class: a
    status: Recommended
    label: Top performer
...
data_cards:
  ...
  - label: Commissions & independence
    ...
    ranked: []
cadence_title: We refresh our analysis at least annually.
